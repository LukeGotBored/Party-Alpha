...
module.exports = {
  ...
  async execute(message, args) {
    ...
    try {
      ...
      // small failsafe
      if(response.cnt.includes("@everyone")){return(message.channel.send("Something went wrong!"))}  
      if(response.cnt.includes("@here")){return(message.channel.send("Something went wrong!"))}  
